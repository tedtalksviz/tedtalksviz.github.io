function createBubbleChart() {
  ...
  function getFillColorScale(data) {
      ...
      return d3.scaleSequential([minAmount, maxAmount * 5], d3.interpolateRainbow);
  }
...
function setScale() {
  ...
  */
  function showDetail(d) {
      ...
      '</span><br/>' +
      '<span class="name">Total views: </span><span class="value">' + d.total.toString() +
      '</span><br/>' +
  ...
  */
  function hideDetail(d) {
      // reset outline
      d3.select(this).attr('fill', fillColor(d.value))
    ...
    bubblesE = bubbles
      .enter()
        ...
        .attr('stroke', function (d) {
          return d3.rgb(fillColor(d.value)).darker(); })
        .attr('stroke-width', 2)
        .on('mouseover', showDetail)
        .on('mouseout', hideDetail);
